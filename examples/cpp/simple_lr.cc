...
spu::hal::Value train(spu::HalContext* ctx, const spu::hal::Value& x,
  ...
  std::cout<<x.shape()[1]<<std::endl;
  std::cout<<"****************y.shape()[0]***************"<<std::endl;
  std::cout<<y.shape()[0]<<std::endl;
  std::cout<<"****************y.shape()[1]***************"<<std::endl;
  std::cout<<y.shape()[1]<<std::endl;
  ...
  for (size_t epoch = 0; epoch < num_epoch; ++epoch) {
    for (size_t iter = 0; iter < num_iter; ++iter) {
      ...
      // std::cout<<"*****************x_slice**************"<<std::endl;
      // std::cout<<x_slice.elsize()<<std::endl;
      // std::cout<<"****************y_slice***************"<<std::endl;
      // std::cout<<y_slice.elsize()<<std::endl;
      // std::cout<<"****************w***************"<<std::endl;
      // std::cout<<w.elsize()<<std::endl;
