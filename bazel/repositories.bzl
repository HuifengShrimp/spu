...
def _bazel_platform():
    http_archive(
        name = "platforms",
        urls = [
            "file:///home/admin/bazel_tools/platforms-0.0.5.tar.gz",
        ],
...
def _com_github_grpc_grpc():
    maybe(
        ...
        type = "tar.gz",
        urls = [
            "file:///home/admin/bazel_tools/grpc-1.45.2.tar.gz",
        ],
    )
...
def _com_github_tensorflow():
    ...
    maybe(
        ...
        urls = [
		"file:///home/admin/bazel_tools/llvm-project-55c71c9eac9bc7f956a05fa9258fad4f86565450.tar.gz",
        ],
    )
    ...
    maybe(
        ...
        type = ".tar.gz",
        urls = [
            "file:///home/admin/bazel_tools/tensorflow-2.9.0.tar.gz",
        ],
    )
...
def _com_github_pybind11():
    maybe(
        ...
        urls = [
            "file:///home/admin/bazel_tools/pybind11-2.9.1.tar.gz",
        ],
    )
...
def _com_github_emptoolkit_emp_ot():
    maybe(
        ...
        urls = [
            "file:///home/admin/bazel_tools/emp-ot-0.2.2.tar.gz",
        ],
