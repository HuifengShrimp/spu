...
#define IMPL_BINARY_OP_WITH_3SIZE(NAME)                                        \
  ...
  //lj
#define IMPL_OP_WITH_3SIZE(NAME)                                        \
  ArrayRef NAME(Object* ctx, const ArrayRef& x, const ArrayRef& w, const ArrayRef& y, size_t sz1, \
                size_t sz2, size_t sz3) {                                      \
    return ctx->call(#NAME, x, w, y, sz1, sz2, sz3);                              \
  } 
...
//lj
IMPL_OP_WITH_3SIZE(logreg_pp)
IMPL_OP_WITH_3SIZE(logreg_ss)
