...
//lj
ArrayRef logreg_pp(Object* ctx, const ArrayRef&, const ArrayRef&, const ArrayRef&, size_t, size_t, size_t);
ArrayRef logreg_ss(Object* ctx, const ArrayRef&, const ArrayRef&, const ArrayRef&, size_t, size_t, size_t);
