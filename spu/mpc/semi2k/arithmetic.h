...
class LogRegAP : public LogRegKernel {
 public:
  static constexpr char kBindName[] = "logreg_ap";
...
class LogRegAA : public LogRegKernel {
  public:
    static constexpr char kBindName[] = "logreg_aa";
